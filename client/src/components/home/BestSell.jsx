      ...
      <Containar>
        <div>
          ...
          >
            ...
            <motion.div
              className="swiper-button-next1 z-20 absolute rounded-full right-1 -top-20 -translate-y-1/2 w-10 h-10 border bg-white 
            hover:bg-primary transition-all ease-linear hover:text-black cursor-pointer hover:border-primary border-[#b6b5b2] flex justify-center items-center text-[#858380]"
            >
              <FaChevronRight className="text-xs" />
            </motion.div>
            <motion.div
              className="swiper-button-prev1 absolute z-20 rounded-full right-14 -top-20 -translate-y-1/2 w-10 h-10 border bg-white 
            hover:bg-primary transition-all ease-linear hover:text-black cursor-pointer hover:border-primary border-[#b6b5b2] flex justify-center items-center text-[#858380]"
            >
          ...
          <div className="flex justify-center">
            <button
              ...
              className="mt-12 px-4 py-2 text-white bg-secendary rounded border-secendary border-2 transition-all duration-300 ease-in-out hover:bg-white hover:text-secendary"
            >
              Show All
            </button>
          </div>
