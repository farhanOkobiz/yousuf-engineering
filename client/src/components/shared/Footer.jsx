            ...
            <div className=" grid grid-cols-12 gap-y-4  md:gap-10">
              ...
              <div className="col-span-12 md:col-span-6 lg:col-span-4 h-auto">
                ...
                <p className="text-[14px] leading-7 text-justify text-gray-600">
                  We Are Yousuf Engineering – Committed to delivering
                  comprehensive HVAC solutions including Air Conditioning, VRF,
                  VRV, and Chiller systems that empower businesses, industries,
                  and commercial establishments with energy-efficient climate
                  control, enhanced comfort, and optimized performance for
