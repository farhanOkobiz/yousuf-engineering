  ...
  return (
    <>
      ...
      <section className="font-inter pt-10 xl:pt-16 bg-[#F2F3F8]">
        <div className="max-w-screen-2xl mx-auto sm:px-10 xl:px-20">
                ...
                <div className="w-full ">
                  ...
                  <div className="mt-6 flex gap-4">
                    <button
                      ...
                      className="px-4 py-2 rounded flex items-center gap-2 bg-primary hover:bg-opacity-80 duration-200 text-black"
                    >
                      <RiShoppingBag2Fill /> কার্টে যোগ করুন
                    </button>
                    <button
                      onClick={() => {
                      ...
                      className=" bg-secendary text-white px-4 py-2 rounded flex items-center gap-2 hover:bg-opacity-70 duration-200"
                    >
