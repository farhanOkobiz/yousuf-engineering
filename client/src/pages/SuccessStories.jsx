                        ...
                        >
                          ...
                          >
                            <div className="absolute right-5 -top-[28px] flex justify-center items-center bg-white w-14 h-14 rounded-full">
                              <div className="w-[44px] h-[44px] rounded-full bg-primary group-hover:bg-secondary border-primary border-2 transition-all ease-in duration-150 flex justify-center items-center">
                                <RiDoubleQuotesR className="text-3xl text-white group-hover:text-primary" />
                              </div>
                            </div>
                            <p
